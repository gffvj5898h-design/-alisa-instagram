...
1. Load `character/references/alice-master-face.png` as a visual reference.
...
The account is a serialized lifestyle story, not a gallery of unrelated attractive portraits.

Every output should preserve continuity in character, biography, age, personality and visual identity.
